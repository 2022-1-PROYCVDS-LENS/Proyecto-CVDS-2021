...
//        }
        ...
        try {
            ...
            instance.reservarRecursos(u, recurso, Timestamp.valueOf("2022-05-05 12:00:00"), Timestamp.valueOf("2022-05-05 13:00:00"), true, "activa", "2022-05-04 21:00:00");

        } catch (ExceptionRecursosBiblioteca exceptionRecursosBiblioteca) {
            exceptionRecursosBiblioteca.printStackTrace();
        }
        }
    }
